(function() { // module pattern
  ...
  var MAP      = { tw: 64, th: 48 },
      ...
      COLOR    = { BLACK: '#FFE2A9', RED: '#FF4B4B', BRICK: '#C57F47', YELLOW: '#EA9753', ORANGE: '#C96A47', BROWN: '#9C593C', SLATE: '#77FF4B', GOLD: 'FF4B4B' },
      COLORS   = [ COLOR.RED, COLOR.BRICK, COLOR.YELLOW, COLOR.ORANGE, COLOR.BROWN ],
  ...
  function checkFinished() { 
    if ( player.collected >= treasure.length && player.killed >= monsters.length ) {
      resetMap()
    }
  }
